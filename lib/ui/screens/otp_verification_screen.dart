            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  userAuthController.otpVerificationInProgress? CircularProgressIndicator():CommonElevatedButton(
                    title: 'Next',
                    onTap: () async{
                      final bool response = await userAuthController.otpVerification(widget.email, _otpETController.text);

                      if(response){
                        Get.to(const HomeScreen());
                      }else{
                        Get.showSnackbar(const GetSnackBar(title: "Otp verification Failed",
                        message: "Check your once again before again it",
                        ),);
                      }
                    },
                  ),
